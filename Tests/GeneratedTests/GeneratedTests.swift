...
final class JSONDecodingRuleGeneratedTests: SwiftLintTestCase {
    func testWithDefaultConfiguration() {
...
final class LocaleOverrideRuleGeneratedTests: SwiftLintTestCase {
    func testWithDefaultConfiguration() {
...
final class NavigationTitleRuleGeneratedTests: SwiftLintTestCase {
    func testWithDefaultConfiguration() {
...
final class StringLocalizationCorrectArgumentsRuleGeneratedTests: SwiftLintTestCase {
    func testWithDefaultConfiguration() {
...
final class TextConcatenationRuleGeneratedTests: SwiftLintTestCase {
    func testWithDefaultConfiguration() {
        verifyRule(TextConcatenationRule.description)
    }
}

final class TextLocalizationRuleGeneratedTests: SwiftLintTestCase {
    func testWithDefaultConfiguration() {
